...
/********************* Start Microassignment zone ********************/
	...
	{
		if (num_elements_in_heap == _items.size() - 1)
		{
			_items.resize(_items.size() * 2);
		}

		//percolate to top
		int hole = ++num_elements_in_heap; // This already increments num_elements_in_heap
